...
public class View_Table_Patients extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Table_Patients frame = new View_Table_Patients();
	...
	public View_Table_Patients() {
		...
		String[] labels = {"Cédula", "Nombres", "Apellidos", "Ocupación", "Profesión", "Fecha de Nacimiento", "Edad", "Teléfonos", "Género", "Lugar de Nacimiento", "Ant. Personales", "Ant. Familiares", "Ant.Gineco-Obst"};
		...
		JLabel lblNewLabel_11 = new JLabel("Listado de Pacientes");
		...
		this.lvtp = new Logic_View_Table_Patients(this);
